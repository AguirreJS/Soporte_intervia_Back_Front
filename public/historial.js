         ...
         if(buscador.value == "") {
            ...
            return new Promise((resolve, reject) => {
               for(i=0; i< history0.length; i++ ){
                  ...
                  const indice6 = history0[i].nota.indexOf(input.value);
                  if (indice !== -1 || indice2 !== -1 || indice3 !== -1 || indice4 !== -1 || indice5 !== -1 || indice6 !== -1) { 
...
if (  facturar1 == true   && history0[i].facturacion1 == "false") {
